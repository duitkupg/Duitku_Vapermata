 ...
 *
 */
namespace Duitku\Vapermata\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Vapermata\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Vapermata\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Vapermata\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
