...
namespace Duitku\Vapermata\Helper;
// include_once('Duitku/ApiRequestor.php');
// include_once('Duitku/DuitkuCore.php');
use Duitku\Vapermata\Helper\DuitkuConstants;
use Duitku\Vapermata\Helper\Duitku\Duitku_Vapermata_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\Vapermata\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Vapermata\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Vapermata\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_vaperepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Vapermata_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Vapermata")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Vapermata\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
