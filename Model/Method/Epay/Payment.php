 ...
 *
 */
namespace Duitku\Vapermata\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Vapermata\Helper\DuitkuConstants;

class Payment extends \Duitku\Vapermata\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vaperepay';
    const METHOD_REFERENCE = 'duitkuvaperReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Vapermata\Block\Info\View';
    ...
    /**
     * @var \Duitku\Vapermata\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Vapermata\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Vapermata\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaperepay/merchantnumber');
	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaperepay/api_key');
    $amount = round($order->getBaseTotalDue());
    
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayvaper/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayvaper/accept');
     ...
     * @return \Duitku\Vapermata\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvaper/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvaper/cancel', ['_secure' => $this->_request->isSecure()]);
    }
